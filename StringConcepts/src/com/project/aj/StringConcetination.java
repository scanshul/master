...
public class StringConcetination {
	public static void main(String[] args) {
		...
		/*
		 * So, a total of three String objects are created:
		 * "ABC" (for s1) "XYZ" (for s2) "ABCXYZ" (result of s1.concat(s2) and passed to
		 * println)
		 */
		...
		/*
		 * Therefore, the objects created are:
		 * One String object for the literal "ABC". One String object for the literal
		 * "XYZ". One String object for the concatenated result "ABCXYZ" (created by
		 * s1.concat(s2), but not assigned to any variable and thus eligible for garbage
		 * collection).
		 */
		...
		//Cannot Concatenate String , because String is immutable we can't changes its content 
		/*
